                                        ...
                                        <ScrollAnimation offset="0" animateIn="fadeInLeft" duration='2.4' animateOnce="true" initiallyVisible ={true}>
                                            <article className={classes.timeline_entry}>
                                                ...
                                                <p>
                                                    ...
                                                    <br />
                                                    <ul>
                                                        <li> Led the automated KYC as a service development for clients onboarded by acquired companies to read data from the database to complete the KYC of critical clients as past of a regulatory commitment</li>
                                                        <li> Designed and implemented Frontend and Backend for our Regulator flow to capture the clients regulators and their validity</li>
                                                        ...
                                                        <li> Tech Stack: Java, React, Spring Boot, Jersey, Apache Kafka, Kubernetes, MongoDB, Sybase, Git, Elasticsearch</li>
                                                    </ul>
                                                </p>
                                                <p>
                                                    ...
                                                    <br />
                                                    <ul>
                                                        <li> Developed multiple Restful web services on top of our Telecommunication Inventory Management product to customize it for satellite communication and integrate with the client's UI</li>
                                                        ...
                                                        <li> Tech Stack: Java, Spring Boot, PL/SQL, Oracle DB, Maven, Perforce</li>
                                                    </ul>
                                                </p>
                                                <p>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li> Tech Stack: Java, Spring Boot, SQL</li>
                                                    </ul>
                                                </p>
                                                <p>
